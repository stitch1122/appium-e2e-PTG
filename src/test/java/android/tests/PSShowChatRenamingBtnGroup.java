...
public class PSShowChatRenamingBtnGroup extends BaseTest{
    ...
    public void groupChatRenamingBtnIsNotShown() throws InterruptedException {
    ...
    public void groupChatRenamingBtnIsShown() throws InterruptedException {
        Activity activity = new Activity(appPackage, "org.telegram.ui.LaunchActivity");
        ((StartsActivity) AppDriver.getDriver()).startActivity(activity);
